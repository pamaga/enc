...
$filters["type"]=( isset($_REQUEST["filtro-type"]))?$_REQUEST["filtro-type"]:"PREVENTA";
...
<form method="post" action="statsgrals.php">
    ...
    <select name="filtro-type">
        ...
        <option value='PREVENTA' <?php if($filters["type"]=="PREVENTA")echo " selected "; ?>>Preventa</option>
        <option value='POSTVENTA' <?php if($filters["type"]=="POSTVENTA")echo " selected "; ?>>Postventa</option>
    </select>
